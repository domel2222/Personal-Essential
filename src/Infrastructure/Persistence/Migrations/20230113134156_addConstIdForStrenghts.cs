...
{
    public partial class addConstIdForStrenghts : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("103a482e-6e62-49e1-b2c9-c251e3955ed2"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6625), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6626), "Futuristic" },
                    { new Guid("2a308e97-5314-4104-a0c6-77c6d56121f1"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6629), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6630), "Connectedness" },
                    { new Guid("3a19987b-2eda-4645-91b5-b285b9113972"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6614), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6615), "Individualization" },
                    { new Guid("6c9eb440-49de-4db5-9b4e-fa21f261d20e"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6633), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6634), "Relator" },
                    { new Guid("7c172324-0b15-4db8-b77f-c9ff75b72218"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6621), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6623), "Activator" },
                    { new Guid("ac23b6c8-8368-4f14-a11b-f0bc24caf864"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6565), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6596), "Responsibility" },
                    { new Guid("cf52fcfb-df40-44da-869f-bcac271194d5"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6600), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6602), "Achiever" },
                    { new Guid("d33453c3-c880-4c5d-a4e9-bc3c6cc2c9a5"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6604), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6606), "Focus" },
                    { new Guid("d571a099-78a6-4a3a-9128-c24d1df7745a"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6617), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6619), "Self-Assurance" },
                    { new Guid("e4013a75-6d0c-40aa-bb38-b6fb69c95d20"), new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6609), null, null, new Guid("af855ff4-c3e3-4a5e-a5a8-6874bd2f7a31"), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6611), "Learner" }
                });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6890), new DateTime(2023, 1, 13, 14, 41, 55, 810, DateTimeKind.Local).AddTicks(6895) });
        }
