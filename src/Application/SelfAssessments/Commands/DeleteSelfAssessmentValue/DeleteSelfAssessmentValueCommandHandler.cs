...
{
    public class DeleteSelfAssessmentValueCommandHandler : ICommandHandler<DeleteSelfAssessmentValueCommand, Unit>
    {
        private readonly ISelfAssessmentValueRepository _selfAssessmentValueRepository;
        private readonly IUnitOfWork _unitOfWork;

        public DeleteSelfAssessmentValueCommandHandler(ISelfAssessmentValueRepository selfAssessmentValueRepository, IUnitOfWork unitOfWork)
        {
